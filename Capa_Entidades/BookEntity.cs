...
namespace Capa_Entidades
{
    ...
    public class BookMetadata
    {
        ...
        [RegularExpression("[a-zA-Z0-9 ]+", ErrorMessage = "&diams; Campo título sólo permite valores alfanuméricos.")]
        public string Title { get; set; }

        [Required(ErrorMessage = "&diams; Debe ingresar un autor.")]
        [StringLength(50, ErrorMessage = "&diams; Máximo 20 caracteres.")]
        [RegularExpression("[a-zA-Z ]+", ErrorMessage = "&diams; Campo autor sólo permite letras.")]
        public string Author { get; set; }

        [Required(ErrorMessage = "&diams; Debe ingresar una descripción.")]
        [StringLength(50, ErrorMessage = "&diams; Máximo 50 caracteres.")]
        [RegularExpression("[a-zA-Z0-9 ]+", ErrorMessage = "&diams; Campo descripción sólo permite valores alfanuméricos.")]
        ...
        [StringLength(50, ErrorMessage = "&diams; Máximo 20 caracteres.")]
        [RegularExpression("[a-zA-Z ]+", ErrorMessage = "&diams; Campo edición sólo permite letras.")]
        public string Edition { get; set; }

        [Required(ErrorMessage = "&diams; Debe ingresar una materia.")]
        [StringLength(50, ErrorMessage = "&diams; Máximo 20 caracteres.")]
        [RegularExpression("[a-zA-Z ]+", ErrorMessage = "&diams; Campo materia sólo permite letras.")]
